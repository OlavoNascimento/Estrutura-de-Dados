...
// A figura não pode nula e seu tipo deve estar contido no enum TiposFigura, desconsiderando os
// tipos TIPOS_FIGURA_MIN e TIPOS_FIGURA_MAX.
...
// A linha não pode ser nula e o tipo deve estar contido no enum TiposFigura, desconsiderando os
// tipos TIPOS_FIGURA_MIN e TIPOS_FIGURA_MAX.
